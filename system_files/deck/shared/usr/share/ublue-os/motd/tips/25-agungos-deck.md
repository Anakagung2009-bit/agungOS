...
The updater built into 󰓓 Steam game mode has been modified to update AgungOS, Flatpaks, and Distrobox containers. *Just ignore the changelog.*
...
*Looking for more security?* Tailscale and OpenVPN are built in, and can be controlled from 󰓓 Steam game mode by the `Tailscale Control` and `TunnelDeck` Decky loader plugins.
