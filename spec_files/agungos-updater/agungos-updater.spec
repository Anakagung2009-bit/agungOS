%global appid io.github.rfrench3.agungos-updater

Name:           agungos-updater
Version:        0.7.3
Release:        1%{?dist}
Summary:        Update your AgungOS system

License:        GPL-2.0-or-later AND BSD-3-Clause AND CC0-1.0
URL:            https://github.com/rfrench3/agungos-updater
...
Provides:       agungos-updater = %{?epoch:%{epoch}:}%{version}-%{release}

%description
This is a convenient, easy-to-use interface for updating your AgungOS system.
- Simple and powerful
...
- Initial rpm build of AgungOS Updater
